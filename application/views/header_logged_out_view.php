					...
					<nav class="navbar navbar-default scrollMenu" role="navigation">
						...
						<div class="collapse navbar-collapse navbar-ex1-collapse" id="scrollTarget">
							<ul class="nav navbar-nav pull-right">
								...
								<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href=#><i class="icon-login"></i>Login</a>
									<ul class="dropdown-menu">
										<?php echo form_open('login')?>
											<div class=dropdown-login>
												  <input type="email" placeholder="Emailadres" class="form-control" name='login_naam' id='login_naam' />
												  <br/>
												  <input type="password" placeholder="Password" class="form-control" name='login_wachtwoord' id='login_wachtwoord' />
												  <br/>
												  ...
												  <a href="<?php echo base_url();?>index.php/login/reset_password">Passwoord vergeten</a>
											</div>
										<?php echo form_close();?>
									</ul>
								</li>
